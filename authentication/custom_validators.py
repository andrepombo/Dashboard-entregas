...
class MyCustomMinimumLengthValidator(object):
        ...
        if len(password) < self.min_length:
            raise ValidationError(
                ngettext(
                    ...
                    "Senha muito curta. It must contain at least %(min_length)d character.",
                    # if it's more than one (which it probably is) put your message here
                    "Senha muito curta. It must contain at least %(min_length)d characters.",
                    self.min_length
                ),
    ...
    def get_help_text(self):
        return ngettext(
            ...
            "Sua senha deve conter ao menos %(min_length)d character.",
            "Sua senha deve conter ao menos %(min_length)d characters.",
            self.min_length
